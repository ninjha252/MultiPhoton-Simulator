...
%generatePlot("3-stage-burst", 'L', "error", 1:80);
%generatePlot("3-stage-profile", 'L', "key", 1:2:150);
%generatePlot("e91-burst", 'L', "error", 1:2:80);
...
function topology = getTopology(scenarioKey, lineIdx, xKey, xValue)
    ...
    elseif (scenarioKey == "3-stage-burst")
         topology = TorusTopology(100, 100, "all", topologyOpts);
    elseif (scenarioKey == "3-stage-burst-torus")
        topology = TorusTopology(250, 250, "all", topologyOpts);
    elseif (scenarioKey == "e91-burst")
         % Single repeater divides distance
